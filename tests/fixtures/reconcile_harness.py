...
def review_submitted_payload(
    *,
    ...
    return {
        ...
        "source_artifact_name": f"reviewer-bot-review-submitted-context-{source_run_id}-attempt-{source_run_attempt}",
...
def review_dismissed_payload(
    *,
    ...
    payload = {
        ...
        "source_run_id": source_run_id,
        "source_run_attempt": source_run_attempt,
        "source_artifact_name": f"reviewer-bot-review-dismissed-context-{source_run_id}-attempt-{source_run_attempt}",
        "source_event_name": "pull_request_review",
...
def issue_comment_payload(
    *,
    ...
    return {
        ...
        "source_run_id": source_run_id,
        "source_run_attempt": source_run_attempt,
        "source_artifact_name": f"reviewer-bot-comment-context-{source_run_id}-attempt-{source_run_attempt}",
...
def review_comment_payload(
    *,
    ...
    payload = {
        ...
        "source_run_id": source_run_id,
        "source_run_attempt": source_run_attempt,
        "source_artifact_name": f"reviewer-bot-review-comment-context-{source_run_id}-attempt-{source_run_attempt}",
