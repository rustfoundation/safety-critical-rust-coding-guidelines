...
def test_i2_comment_application_routes_using_string_kinds():
    assert comment_application._route_comment_application(
        {"comment_class": "plain_text", "command_count": 0},
        comment_id=10,
    ) == "freshness_only"
    assert comment_application._route_comment_application(
        {"comment_class": "command_only", "command_count": 1},
        comment_id=10,
    ) == "command_only"
    assert comment_application._route_comment_application(
        {"comment_class": "command_plus_text", "command_count": 1},
        comment_id=10,
    ) == "both"
    assert comment_application._route_comment_application(
        {"comment_class": "plain_text", "command_count": 0},
