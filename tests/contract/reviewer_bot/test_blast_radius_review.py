...
def test_f3_blast_radius_review_matches_current_owner_locations():
    ...
    assert "live_review_support.read_pull_request_result(" in live_repair_text
    ...
    assert "live_review_support.projection_failure_result(" in approval_policy_text
    assert "live_review_support.read_pull_request_result(" in approval_policy_text
    assert "live_review_support.read_pull_request_reviews_result(" in approval_policy_text
    assert "live_review_support.permission_status(" in approval_policy_text
    assert "live_review_support.parse_github_timestamp" in approval_policy_text
