...
def test_comment_application_no_longer_owns_direct_comment_freshness_decision_branching():
    ...
    assert "comment_freshness_policy.build_comment_freshness_event(effective_review_data, request)" in module_text
    assert "comment_freshness_policy.decide_comment_freshness_event(event, current_head_sha=current_head_sha)" in module_text
